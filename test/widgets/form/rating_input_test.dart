  ...
  group('RatingInputWidget', () {
    testWidgets('renders correct number of stars', (tester) async {
      await tester.pumpWidget(wrap(
        RatingInputWidget(maxStars: 5, allowHalf: false, dispatchEvent: (_) {}),
      ));
    ...
    testWidgets('dispatches event on star tap', (tester) async {
      final events = <String>[];
      await tester.pumpWidget(wrap(
        RatingInputWidget(maxStars: 5, allowHalf: false, dispatchEvent: events.add),
      ));
    ...
    testWidgets('renders title when provided', (tester) async {
      await tester.pumpWidget(wrap(
        RatingInputWidget(title: 'Feedback', maxStars: 5, allowHalf: false, dispatchEvent: (_) {}),
      ));
